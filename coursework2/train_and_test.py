...
from agent_withPERB import Agent
...
if __name__ == "__main__":
    ...
    #np.random.seed(1606588311)    #difficult maze
    np.random.seed(1606694413)
    ...
    while time.time() < end_time:
        ...
        if agent.has_finished_episode():
            state = environment.init_state
            print("finished episode in time:", (time.time() - start_time)/60 )
    ...
    #Draw greedy policy:
    environment.draw_greedy_pol(greedy_states)